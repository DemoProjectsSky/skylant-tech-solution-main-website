        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
            ...
            <div className="flex items-center gap-3">
              ...
              <Link
                to="/contact"
                className="hidden lg:inline-flex items-center gap-2 rounded-xl bg-[#7C3AED] px-5 py-2.5 text-sm font-semibold text-white shadow-md transition-all duration-300 hover:bg-[#7C3AED] hover:shadow-lg"
              >
                Get started
                ...
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  {services.map((s) => (
                    ...
                    >
                      ...
                      <div className="text-[#312E81] text-sm font-medium">
                        {s.title}
                      </div>
                    </Link>
                  ))}
        ...
        {mobileOpen && (
          ...
          >
            ...
            <motion.div
              ...
              className="absolute right-0 top-0 bottom-0 w-80 max-w-[85vw] bg-white p-6 pt-24 overflow-y-auto shadow-2xl"
            >
              ...
              <div className="flex flex-col gap-1">
                ...
                {services.map((s) => (
                  <Link
                    ...
                    to={`/services/${s.slug}`}
                    onClick={() => setMobileOpen(false)}
                    className="px-4 py-2.5 rounded-xl text-sm font-medium text-black opacity-80 hover:opacity-100 hover:bg-black/5 hover:text-black transition-all pl-8"
                  >
                    {s.title}
                  </Link>
                ))}
